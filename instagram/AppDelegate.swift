...
//  instagram
//
//  Created by Joakim Jorde on 9/26/18.
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        Parse.initialize(
            with: ParseClientConfiguration(block: { (configuration: ParseMutableClientConfiguration) -> Void in
                configuration.applicationId = "codepath_instagram-parse"
                configuration.clientKey = "j2i3hfndj42jdfuh4jkjfshfuisdhfsuidfh89sdfbi3"  // set to nil assuming you have not set clientKey
                configuration.server = "https://instagramtonull.herokuapp.com/parse"
            })
        )
